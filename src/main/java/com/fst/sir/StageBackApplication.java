...
public class StageBackApplication {
    ...
    CommandLineRunner start(UserService userService) {
        return args -> {
            if (false) {
                User user = new User("khalil" + UUID.randomUUID().toString(), UUID.randomUUID().toString(), UUID.randomUUID().toString(), UUID.randomUUID().toString());
...
/*
                    User user = new User("khalil","990we70898rw","kha","KHalil@2018");
